...
与 [`karpathy-wiki/references/skill-install.md`](https://github.com/c456-com/skills/blob/main/karpathy-wiki/references/skill-install.md) **内容一致**；本文件随 `wiki-book-ingest` 安装，供单独加载本技能时使用。
